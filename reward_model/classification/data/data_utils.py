...
def prepare_train(
    ...
    def promt_tokenize(examples):
        ...
        return {
            "input_ids_j": j_sample,
            "attention_mask_j": j_attention_mask,
            "input_ids_k": k_sample,
            "attention_mask_k": k_attention_mask,
        }
    ...
    return DataLoader(
        ...
        collate_fn=lambda data: {
            "input_ids_j": collate_batch(
                [f["input_ids_j"] for f in data], tokenizer, max_length=max_length
            ),
            ...
            "input_ids_k": collate_batch(
                [f["input_ids_k"] for f in data], tokenizer, max_length=max_length
            ),
